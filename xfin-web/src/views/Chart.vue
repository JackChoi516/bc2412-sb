  ...
  setup() {
    ...
    const setChartType = (type) => {
      ...
      if (type === 'line') {
        ...
        // Trigger a re-render by updating a dummy reactive value
      chartType.value = null;  // Reset the chart type first
      nextTick(() => {  // Wait for the DOM update and then set the chart type again

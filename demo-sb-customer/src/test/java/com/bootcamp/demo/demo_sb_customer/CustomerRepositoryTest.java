...
public class CustomerRepositoryTest {
  ...
  // ! This Unit Test provided the repository bean, generated by Hibernate, is corr
  @Test
  void testSaveAndFindAll(){
    ...
    CustomerEntity customerEntity = this.customerRepository.save(john);
    ...
    CustomerEntity customerEntity2 = this.customerRepository.save(mary);
